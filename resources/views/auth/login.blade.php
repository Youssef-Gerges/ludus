                                    ...
                                    <div class="l-f-o__pad-box">
                                        ...
                                        @endif
                                            ...
                                            <div class="u-s-m-b-30">
                                                ...
                                                <input class="input-text input-text--primary-style" type="text" id="login-email" placeholder="Enter E-mail" name="email" required>
                                            </div>
                                            <div class="u-s-m-b-30">

                                                <label class="gl-label" for="login-password">PASSWORD *</label>

                                                <input class="input-text input-text--primary-style" type="password" id="login-password" placeholder="Enter Password" required name="password">
                                            </div>
                                            <div class="gl-inline">
                                                <div class="u-s-m-b-30">
